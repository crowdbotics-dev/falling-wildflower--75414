...
## Project Structure
    ...
    ├── falling_wildflower__75414  # Django project configurations
...
1. Clone this repo and `cd falling_wildflower__75414`
...
2. Clone this repo and `cd falling_wildflower__75414`
